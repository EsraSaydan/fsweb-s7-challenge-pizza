...
export default function Navbar() {
  return (
    <div className="">
      <div className="grid grid-cols-3 md:grid-cols-6 space-x-1 lg:space-x-3 mt-0 mb-0 font-roboto px-[20px] lg:px-[135px]  md:gap-3  lg:mx-auto">
        <div className="flex items-center space-x-1 bg-white lg:space-x-2 font-barlow  py-2 lg:py-3 px-4 mt-2 hover:scale-105 duration-300">
        ...
        <div className="flex items-center space-x-1 bg-white lg:space-x-2 font-barlow  py-2 lg:py-3 px-4 mt-2 hover:scale-105 duration-300">
          ...
          <p className="font-semibold text-[13px] lg:text-[10px]">
            Kızartmalar
          </p>
        </div>
